...
=== "Layer 2: Data Link"
    ...
    | **OUI_Distribution** | `distribution(oui)` | <span class="ktp-metric-detail" data-meso="Vendor analysis; identifies the manufacturer of devices." data-macro="Fleet composition; tracks the mix of vendors in the environment."><span class="ktp-info-icon" aria-hidden="true">i</span></span> |
